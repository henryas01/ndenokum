...
const WhoWeAre = () => {
  return (
    <section className="bg-orange-100 text-justify-center  bg-gradient-to-r from-orange-100 to-orange-400 px-6 md:px-20 py-16">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-justify-center">
        {/* Text Section */}
        <div>
